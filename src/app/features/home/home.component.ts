...
@Component({
          ...
          <div class="footer-content">
            ...
            <div class="footer-links">
              <div class="footer-section">
                ...
                <ul>
                  <li><a href="#">{{ 'footer.links.about' | translate }}</a></li>
                  <li><a href="#">{{ 'footer.links.contact' | translate }}</a></li>
                  <li><a href="#">{{ 'footer.links.privacy' | translate }}</a></li>
    ...
    .language-selector button, .theme-toggle {
    ...
    .language-selector button:hover, .theme-toggle:hover {
